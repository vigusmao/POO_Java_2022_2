...
public class BibliotecaTest {
    ...
    public void setUp() {
        ...
        usuarioFantasma = new Pessoa("Usuário Fantasma", 9876);
        ...
        livroRaro = new Livro("Algum model.Livro", algumAutor, 1900, Livro.TipoDeLivro.LIVRO_DE_FICCAO);
        ...
        biblioteca.adquirirLivro(livroRaro, 1);
    ...
    public void testeAdquirirNovoLivro() {
        ...
        // vamos adquirir um novo livro para a nossa biblioteca
        ...
        assertEquals("A aquisição de um livro deve atualizar a quantidade TOTAL de livros na estante",
                16, biblioteca.getQuantidadeDeLivrosNasEstantes());  // note que já 6 livros foram adquiridos no setUp()
    }
